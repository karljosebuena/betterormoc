    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-12">
        ...
        <div className="mb-6 text-sm text-gray-600">
          Showing {filteredData.reduce((sum, cat) => sum + cat.stats.length, 0)}{' '}
          statistics
                ...
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {categoryData.stats.length} data points
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-12 rounded-lg border border-blue-200 bg-blue-50 p-6">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <p>
              • <strong>Philippine Statistics Authority (PSA)</strong> - 2020
              Census data
            </p>
            <p>
              •{' '}
            ...
            <p>
              • <strong>LGU Ormoc</strong> - City government data and reports
              (2023-2025)
            </p>
            <p>
              • <strong>Various Department Reports</strong> - Agriculture,
              Health, Education, Tourism
            </p>
          </div>
          <p className="mt-4 text-xs text-gray-600">
            All statistics are from official government sources and are updated
