    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-12">
        ...
        <div className="mb-6 text-sm text-gray-600">
          Showing {filteredOrdinances.length}{' '}
          {filteredOrdinances.length === 1 ? 'ordinance' : 'ordinances'}
        </div>
        ...
        {filteredOrdinances.length === 0 ? (
          <div className="rounded-lg border border-gray-200 bg-white p-12 text-center">
            ...
            <p className="text-gray-600">
              No ordinances found for the selected year.
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span>
                          {new Date(ordinance.date_approved).toLocaleDateString(
                            'en-US',
                            {
                              year: 'numeric',
                              month: 'long',
