        ...
        <div className="min-h-screen bg-gray-50 pb-16">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-blue-950 py-16 text-white">
                <div className="container">
                    ...
                    <p className="text-xl text-blue-100">How we collect, use, and protect your information</p>
                </div>
            </div>
                ...
                <div className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-sm lg:p-12">
                    <div className="prose prose-lg max-w-none text-gray-600">
                        <section className="mb-12">
                            ...
                            <p className="mb-4">
                                BetterOrmoc.org ("we," "us," or "our") is committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
                            </p>
                            <p className="mb-6">
                        ...
                        <section className="mb-12">
                            ...
                            <p className="mb-4">We collect minimal information necessary to operate this civic platform effectively:</p>

                            <h3 className="mb-2 text-xl font-semibold text-gray-800">Information You Provide Voluntarily</h3>
                            ...
                            <h3 className="mb-2 text-xl font-semibold text-gray-800">Information Collected Automatically</h3>
                            <ul className="mb-6 list-disc pl-6">
                        ...
                        <section className="mb-12">
                            ...
                            <ul className="list-disc pl-6">
                                <li><strong>Service Providers:</strong> With trusted third-party services (e.g., web hosting, analytics) that assist in operating our website</li>
                                ...
                                <li><strong>Protection of Rights:</strong> To protect the rights, property, or safety of BetterOrmoc.org, our users, or the public</li>
                            </ul>
                        </section>
                        ...
                        <section className="mb-12">
                            ...
                            <p className="mb-4">
                                Under the Data Privacy Act of 2012, you have the right to access, correct, and request deletion of your personal data. To exercise these rights, please contact us.
                            </p>
                        </section>
