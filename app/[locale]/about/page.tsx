        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <div className="rounded-lg border-2 border-yellow-300 bg-yellow-50 p-6">
            ...
            <div className="space-y-3 text-yellow-900">
              ...
              <p>
                BetterOrmoc is an{' '}
                <strong>independent, unofficial community project</strong>{' '}
                created to help Ormocanons easily find information about city
                services, government offices, and public resources.
              </p>
              <p>
                This website is{' '}
                <strong>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                BetterOrmoc is a personal project built with the goal of making
                it easier for residents and visitors to navigate Ormoc City's
                services and resources.
              </p>
              <p>
                The platform aggregates publicly available information from
                various sources to provide a centralized, user-friendly portal
                for:
              </p>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                All information on this website is compiled from publicly
              ...
              <p className="text-sm italic">
                <strong>Note:</strong> While we strive for accuracy, information
                may become outdated. Always verify critical information with
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                BetterOrmoc is built with modern web technologies and is open
                source. The code is available for anyone to review, contribute
                to, or use as inspiration for similar projects in other cities.
              </p>
          ...
          <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Have suggestions, corrections, or want to contribute? We'd love
                to hear from you!
              </p>
          ...
          <div className="rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              A personal project by a fellow Ormocanon who wants to make city
