                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            <p className="text-sm text-yellow-800">
                                <strong className="font-semibold">Data Verification Notice:</strong> Mayor and Vice Mayor information has been verified from official sources.
                                Sangguniang Panlungsod members and Department Heads data are placeholders pending official roster verification,
                                as this information is not publicly available online. We are actively working to obtain and verify the complete official roster.
                            </p>
                        </div>
                    </div>
                </div>
