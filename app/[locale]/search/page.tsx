            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 py-3 pr-12 pl-12 text-base outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-900"
                />
                {searchInput && (
                  <button
                    type="button"
              ...
              <>
                ...
                <div className="space-y-8">
                  {Object.entries(groupedResults).map(([resultType, items]) => {
                    ...
                    return (
                      <div key={resultType}>
                        <h2 className="mb-4 text-lg font-semibold tracking-wide text-gray-500 uppercase">
