      ...
      <div className="bg-gradient-to-r from-blue-900 to-blue-950 py-16 text-white">
        <div className="container">
          ...
          <p className="text-xl text-blue-100">
            Navigate all pages and services of BetterOrmoc.org
          </p>
        </div>
      </div>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div className="space-y-3">
              <Link
                href="/"
                className="flex items-center gap-2 text-gray-600 transition-colors hover:text-blue-900"
              >
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            <div className="space-y-3">
              ...
              {/* Business */}
              <div className="mt-4 mb-2 text-xs font-semibold tracking-wider text-gray-500 uppercase">
                Business & Tax
              </div>
              <Link
                href="/services/business-permit-new"
                className="flex items-center gap-2 text-gray-600 transition-colors hover:text-blue-900"
              >
                <ArrowRight className="h-4 w-4 text-gray-400" />
                Business Permit
              ...
              <Link
                href="/services/real-property-tax-payment"
                className="flex items-center gap-2 text-gray-600 transition-colors hover:text-blue-900"
              >
                <ArrowRight className="h-4 w-4 text-gray-400" />
                Real Property Tax
              ...
              <Link
                href="/services"
                className="mt-4 flex items-center gap-2 text-sm font-semibold text-blue-700 hover:underline"
              >
