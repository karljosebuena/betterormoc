...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'You can browse all available services on our Services page. Each service listing includes requirements, fees, processing time, and the office responsible. Some services can be accessed online through our partner platforms.',
  },
  {
    category: 'Services',
    question: 'How do I get a birth certificate?',
    answer:
      'Visit the Local Civil Registrar office with a valid ID and payment of ₱150. Processing time is 15-30 minutes. You can also check the Birth Certificate service page for detailed requirements.',
  },
  {
    category: 'Services',
    question: 'How long does it take to get a business permit?',
    answer:
      'New business permits typically take 3-5 days to process. Renewals can be completed on the same day. Visit the Business Permits & Licensing Office for more information.',
  },
  {
    category: 'Services',
  ...
  },
  {
    ...
    answer:
      'Visit our Government page to see contact information for all city officials. You can also send inquiries through our Contact page.',
  },
  {
    category: 'Government',
    question: 'Where can I view city ordinances and resolutions?',
    answer:
      'All ordinances and resolutions are available on our Legislative pages. You can filter by year and category to find specific documents.',
  },
  {
    category: 'Technical',
    question: 'Is my personal information secure?',
    answer:
      'Yes. We follow strict data privacy protocols in compliance with the Data Privacy Act of 2012. Your information is only used for official government purposes.',
  },
]
