                ...
                <div className="mx-auto max-w-4xl space-y-12">
                    ...
                    <section>
                        ...
                        <p className="text-gray-600">
                            The City Government of Ormoc is committed to ensuring digital accessibility for people
                    ...
                    {/* Standards */}
                    <section>
                        <h2 className="mb-4 text-2xl font-bold text-gray-900">Standards Compliance</h2>
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                    ...
                    <section>
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <p className="mb-4 text-gray-600">
                                We welcome your feedback on the accessibility of BetterOrmoc.org. Please let us know
                    ...
                    {/* Limitations */}
                    <section>
                        <h2 className="mb-4 text-2xl font-bold text-gray-900">Known Limitations</h2>
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <p className="mb-4 text-gray-600">
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li>• Some legacy content is being updated for better accessibility</li>
                            </ul>
                    ...
                    <section>
                        <h2 className="mb-4 text-2xl font-bold text-gray-900">Technical Specifications</h2>
                        <div className="rounded-lg border border-gray-200 bg-white p-6">
                            <p className="mb-4 text-gray-600">
