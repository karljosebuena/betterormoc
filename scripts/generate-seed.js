...
// Paths
const BETTERSOLANO_DATA =
  '/Users/karljosebuena/Documents/personal/repos/bettersolano/data'
const OUTPUT_FILE =
  '/Users/karljosebuena/Documents/personal/repos/betterormoc-ts/supabase/seed.sql'
...
const servicesData = JSON.parse(
  fs.readFileSync(path.join(BETTERSOLANO_DATA, 'services.json'), 'utf8')
)
const officialsData = JSON.parse(
  fs.readFileSync(path.join(BETTERSOLANO_DATA, 'officials.json'), 'utf8')
)
const ordinancesData = JSON.parse(
  fs.readFileSync(path.join(BETTERSOLANO_DATA, 'ordinances.json'), 'utf8')
)
const resolutionsData = JSON.parse(
  fs.readFileSync(path.join(BETTERSOLANO_DATA, 'resolutions.json'), 'utf8')
)
