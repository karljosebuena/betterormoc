  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
      ...
      <p className="mb-6 text-gray-600">
        Follow these steps to request your service
      </p>
        ...
        {sortedSteps.map((step, index) => (
          <div key={index} className="flex gap-4">
            ...
            {index < sortedSteps.length - 1 && (
              <div
                className="absolute mt-12 ml-5 h-full w-0.5 bg-gray-200"
                style={{ height: '2rem' }}
              />
            )}
          </div>
      ...
      <div className="mt-8 flex items-start gap-3 rounded-lg bg-green-50 p-4">
        ...
        <p className="text-sm text-green-800">
          Complete all steps to successfully obtain your service. Processing
          times may vary.
        </p>
      </div>
    </div>
