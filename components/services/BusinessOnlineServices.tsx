    ...
    <div className="mb-12 rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-8">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="text-gray-600">
          Complete your business transactions online through official Ormoc City
          portals
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {businessOnlineServices.map((service) => (
          <a
            ...
            className="group relative overflow-hidden rounded-lg border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-blue-300 hover:shadow-md"
          >
            {/* External Badge */}
