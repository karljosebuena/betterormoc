    ...
    <section className="section bg-white">
      <div className="container">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            Stay informed about the latest news and announcements from Google
            News
          </p>
        </div>
          ...
          {news.map((item, index) => (
            ...
            >
              <div className="p-6">
                ...
                <h3 className="mb-2 line-clamp-2 text-lg font-semibold text-gray-900 group-hover:text-blue-900">
                  {item.title}
                </h3>
                <p
