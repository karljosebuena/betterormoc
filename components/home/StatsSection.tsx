                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {stats?.map((stat) => {
                        ...
                        return (
                            <div
                                key={stat.id}
                                className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-blue-900 hover:shadow-md"
                            >
                                <div className="mb-4 inline-flex rounded-lg bg-blue-50 p-3 text-blue-900">
