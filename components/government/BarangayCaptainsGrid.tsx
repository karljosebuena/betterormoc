...
export function BarangayCaptainsGrid() {
    ...
    const filteredBarangays = barangays.filter(b => {
        const matchesSearch = b.barangay_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div>
                    ...
                    >
                        <div className="mb-3 flex items-start justify-between">
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-900">{barangay.barangay_name}</h3>
                                <p className="mt-1 text-sm text-gray-600">{barangay.captain_name}</p>
                            </div>
            ...
            {filteredBarangays.length === 0 && (
                <div className="py-12 text-center">
                    <p className="text-gray-500">No barangays found matching your search.</p>
                </div>
            )}
        </div>
    )
