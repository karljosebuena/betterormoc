...
const footerLinks = {
    ...
    resources: [
        { name: 'Open Data Philippines', href: 'https://data.gov.ph', external: true },
        { name: 'Freedom of Information', href: 'https://www.foi.gov.ph/', external: true },
        { name: 'Official LGU Ormoc Portal', href: 'https://ormoc.gov.ph/', external: true },
    ],
}
            ...
            <div className="container py-12">
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-800 pt-8 md:flex-row">
                    <div className="text-center text-sm md:text-left">
                        <p>
                            © {currentYear} BetterOrmoc. MIT | CC BY 4.0
                        </p>
                ...
                <div className="mt-4 text-center text-xs text-gray-500">
                    <p className="flex items-center justify-center gap-1">
                        Built with <Heart className="h-3 w-3 fill-red-500 text-red-500" /> for
                        the people of Ormoc City
                    </p>
                </div>
            </div>
        </footer>
