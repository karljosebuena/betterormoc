  ...
  return (
    <div className="border-b border-gray-200 bg-red-600 text-white">
      <div className="container">
        <div className="scrollbar-hide flex items-center gap-4 overflow-x-auto py-2">
          {hotlines.map((hotline) => (
            <Link
              key={hotline.label}
              href={hotline.href}
              className="flex items-center gap-2 text-sm whitespace-nowrap transition-opacity hover:opacity-80"
            >
